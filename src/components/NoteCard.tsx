    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        <Dialog.Overlay className="inset-0 fixed bg-black/50">
          <Dialog.Content className="fixed overflow-hidden inset-0 w-full bg-slate-700 md:inset-auto md:rounded-md md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] md:h-[60vh] flex flex-col outline-none">
            ...
            <button
              type="button"
              className="w-full bg-slate-800 py-4 text-center text-sm text-slate-300 outline-none font-bold group"
            >
              Do you want to{' '}
